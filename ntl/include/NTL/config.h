 ...
 * You will also have to set the variables GF2X_INCDIR,
 * GF2X_LIBDIR, and GF2X_LIB in the makefile (these are set automatically
 ...
 * You may also have to edit the makefile to modify the variables
 * GF2X_INCDIR, GF2X_LIBDIR, and GF2X_LIB.
 */
